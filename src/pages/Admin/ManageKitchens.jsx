  ...
  return (
    <AdminLayout>
      <div className="max-w-7xl mx-auto">
        {/* Header section with Stats Badge */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
          ...
          <div className={`px-6 py-3 rounded-2xl border font-black text-xs uppercase tracking-widest ${
            isDarkMode ? "bg-white/5 border-white/10" : "bg-indigo-50 border-indigo-100 text-indigo-600"
          }`}>
            Active Partners: {kitchens.length}
          </div>
        </div>
        ...
        {loading ? (
          <div className="flex flex-col justify-center items-center h-64">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-40">Fetching Database...</p>
          </div>
        ) : kitchens.length === 0 ? (
                      ...
                      <td className="py-6 px-6">
                        <div className="space-y-1">
                          <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-tight">
                            <FiUser size={12} className="text-indigo-500" /> {kitchen.ownerName}
                          </div>
                          <div className="flex items-center gap-2 text-[11px] opacity-50 italic">
                            <FiMail size={12} /> {kitchen.ownerEmail}
                          </div>
                        </div>
                      </td>
